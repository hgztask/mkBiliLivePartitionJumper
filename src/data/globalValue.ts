...
export default {
    ...
    scriptCat_js_url: 'https://scriptcat.org/zh-CN/script-show-page/6248',
    greasyFork_js_url: 'https://greasyfork.org/zh-CN/scripts/577801',
    github_url: 'https://github.com/hgztask/mkBiliLivePartitionJumper',
